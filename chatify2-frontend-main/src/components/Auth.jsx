...
//creating a cookie object to store the data of the user
...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // if isSignup is true then create user else login user
        // data object contains the data sent back by the post request
        const { data: { token, userId, hashedPassword, fullName } } = await axios.post(`${URL}/${isSignup ? 'signup' : 'login'}`, {
            username, password, fullName: form.fullName, phoneNumber, avatarURL, //this data is sent to backend
        });
